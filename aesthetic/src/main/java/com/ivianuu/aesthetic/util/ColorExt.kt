...
internal fun Int.isDark() = !isLight()

internal fun Int.isLight(): Boolean {
    if (this == Color.BLACK) {
        return false
...
internal fun Int.darken() = shiftColor(0.9f)

internal fun Int.lighten() = shiftColor(1.1f)

internal fun Int.shiftColor(by: Float): Int {
