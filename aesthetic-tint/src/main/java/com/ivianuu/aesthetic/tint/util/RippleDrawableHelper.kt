...
object RippleDrawableHelper {
    ...
    fun getRippleDrawable(context: Context): Drawable {
        return getRippleDrawable(context, MaterialColorHelper.isDarkTheme(context))
    }

    fun getRippleDrawable(context: Context, color: Int): Drawable {
        return getRippleDrawable(context, color.isDark())
    }

    fun getRippleDrawable(context: Context, dark: Boolean): Drawable {
        return getRippleDrawable(MaterialColorHelper.getRippleColor(context, dark))
    }
    ...
    fun getBorderlessRippleDrawable(context: Context): Drawable {
        return getBorderlessRippleDrawable(context, MaterialColorHelper.isDarkTheme(context))
    }

    fun getBorderlessRippleDrawable(context: Context, color: Int): Drawable {
        return getBorderlessRippleDrawable(context, color.isDark())
    }

    fun getBorderlessRippleDrawable(context: Context, dark: Boolean): Drawable {
        return getBorderlessRippleDrawable(MaterialColorHelper.getRippleColor(context, dark))
    }
